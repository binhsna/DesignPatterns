...
/*
 * Biến volatile trong Java có tác dụng
 * thông báo sự thay đổi giá trị của biến
 * tới các thread khác nhau nếu biến này đang được sử dụng trong nhiều thread.
 * */
/*
 * Cách này có nhược điểm là một phương thức synchronized
 * sẽ chạy rất chậm và tốn hiệu năng,
